...
const CTA = () => {
  return (
    <section className="py-20 px-6">
      <div className="max-w-5xl mx-auto border border-orange-200 rounded-3xl bg-white shadow-[0_0_70px_rgba(249,115,22,0.12)]">
        <div className="flex flex-col items-center text-center px-8 py-20">
          ...
          <button className="mt-10 flex items-center gap-2 rounded-xl bg-orange-500 px-8 py-4 text-white font-semibold shadow-lg shadow-orange-300 transition hover:bg-orange-600 hover:scale-105">
            <Link
            to="/login"
            >
                Try WireframeAI
